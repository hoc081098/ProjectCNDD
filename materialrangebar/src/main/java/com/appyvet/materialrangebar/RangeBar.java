...
public class RangeBar extends View {
    ...
    private static final float DEFAULT_TICK_START = 100_000;

    private static final float DEFAULT_TICK_END = 10_000_000;

    private static final float DEFAULT_TICK_INTERVAL = 100_000;
    ...
    public void setTickStart(float tickStart) {
        ...
        if (isValidTickCount(tickCount)) {
            ...
            Log.e("@@@@", "tickCount less than 2; invalid tickCount.");
